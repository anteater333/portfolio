...
function ContactsSection({ updateLoadingProgress }: SectionProps) {
  ...
  return (
    <section
      id="contacts-section"
      className="relative flex h-recommended snap-center flex-col items-center overflow-scroll bg-pureBlack text-white"
    >
      <h1 className="mt-20 border-b-[1rem] border-b-white text-10xl font-bold leading-[10rem] ">
        Contacts
      </h1>

      <h2 className="mt-32 text-8xl font-bold">이지훈</h2>
